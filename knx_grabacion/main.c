...
int GrabaParamTemp(char * textParam, char * KNXParam, Dato* TablaParam, int NumElmTablaParam);
int GrabaParamFlag(char * textParam, char * KNXParam, Dato* TablaParam, int NumElmTablaParam); 
...
main (int ac, char *ag[])
{
  ...
  /*
		...
		dat5   CLIMA_MODO_FUNC        1/4 coolinng / heating
  ...
  */
  ...
  GrabaParamFlag(parametro, "1/0",  tablaParam, IndiceTabla);
  
  sprintf(parametro,"%s_dat2",ag[2]);
  GrabaParamFlag(parametro, "1/1",  tablaParam, IndiceTabla);
 
 sprintf(parametro,"%s_dat4",ag[2]);
  GrabaParamFlag(parametro, "1/3",  tablaParam, IndiceTabla);
    
  sprintf(parametro,"%s_dat5",ag[2]);
    GrabaParamFlag(parametro, "1/4",  tablaParam, IndiceTabla);
 
   sleep(1);

  
   sprintf(parametro,"%s_dat6",ag[2]);
  GrabaParamTemp(parametro, "1/5", tablaParam, IndiceTabla);
  
  sleep(1);
 
   sprintf(parametro,"%s_dat3",ag[2]);
  GrabaParamTemp(parametro, "1/2", tablaParam, IndiceTabla);
 ...
 int GrabaParamTemp(char * textParam, char * KNXParam, Dato* TablaParam, int NumElmTablaParam)
 {
  ...
  if(pos!=-1)
  {
	...
	if( GrabaParametroTempKNX("ip:localhost",KNXParam, TablaParam[pos].Valor))  // antes "1/2"
	{
		retorno = 1;
 ...
 int GrabaParamFlag(char * textParam, char * KNXParam, Dato* TablaParam, int NumElmTablaParam)
 {
  ...
  if(pos!=-1)
  {
	...
	if( GrabaParametroKNX(KNXParam, TablaParam[pos].Valor))  // antes "1/2"
	{
		retorno = 1;
		//printf("parametro grabado %s\n",parametro);
	}
